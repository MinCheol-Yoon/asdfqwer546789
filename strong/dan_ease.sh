...
python main.py --dataset="gowalla" --model="DAN" --reg_p=5 --alpha=0.8 --beta=0.1 --diag_const=True --diag_relax=False &&
python main.py --dataset="yelp2018" --model="DAN" --reg_p=5 --alpha=0.6 --beta=0.4 --diag_const=True --diag_relax=False &&
python main.py --dataset="abook" --model="DAN" --reg_p=1 --alpha=0.7 --beta=0.4 --diag_const=True --diag_relax=False 
