...
python main.py --dataset="gowalla" --model="DAN" --reg_p=5 --alpha=0.8 --beta=0.2 &&
python main.py --dataset="yelp2018" --model="DAN" --reg_p=5 --alpha=0.6 --beta=0.4  &&
python main.py --dataset="abook" --model="DAN" --reg_p=2 --alpha=0.8 --beta=0
